...
{
    internal class Internal_ITestDictState : ITestDictStateClient, ITestDictState 
    , IInitStateData 
    {
        ...
        IReadOnlyReactiveDictionary<String, String> ITestDictStateClient.DictElement => LD_DictElement.Interface;
        public IReadOnlyReactiveProperty<String> GetDictElementProperty(String key)
        {
            return LD_DictElement.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<String, Int32> ITestDictStateClient.DictElement1 => LD_DictElement1.Interface;
        public IReadOnlyReactiveProperty<Int32?> GetDictElement1Property(String key)
        {
            return LD_DictElement1.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<String, Int64> ITestDictStateClient.DictElement2 => LD_DictElement2.Interface;
        public IReadOnlyReactiveProperty<Int64?> GetDictElement2Property(String key)
        {
            return LD_DictElement2.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<String, Single> ITestDictStateClient.DictElement3 => LD_DictElement3.Interface;
        public IReadOnlyReactiveProperty<Single?> GetDictElement3Property(String key)
        {
            return LD_DictElement3.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<String, Double> ITestDictStateClient.DictElement4 => LD_DictElement4.Interface;
        public IReadOnlyReactiveProperty<Double?> GetDictElement4Property(String key)
        {
            return LD_DictElement4.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<String, Boolean> ITestDictStateClient.DictElement5 => LD_DictElement5.Interface;
        public IReadOnlyReactiveProperty<Boolean?> GetDictElement5Property(String key)
        {
            return LD_DictElement5.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<String, ITestSampleStateClient> ITestDictStateClient.DictElement8 => LD_DictElement8.Interface;
        public IReadOnlyReactiveProperty<ITestSampleStateClient> GetDictElement8Property(String key)
        {
            return LD_DictElement8.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<Int32, String> ITestDictStateClient.DictElement9 => LD_DictElement9.Interface;
        public IReadOnlyReactiveProperty<String> GetDictElement9Property(Int32 key)
        {
            return LD_DictElement9.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<Int32, ITestSampleStateClient> ITestDictStateClient.DictElement10 => LD_DictElement10.Interface;
        public IReadOnlyReactiveProperty<ITestSampleStateClient> GetDictElement10Property(Int32 key)
        {
            return LD_DictElement10.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<String, Int32[]> ITestDictStateClient.DictElement11 => LD_DictElement11.Interface;
        public IReadOnlyReactiveProperty<Int32[]> GetDictElement11Property(String key)
        {
            return LD_DictElement11.GetProperty(key);
        }
        IReadOnlyReactiveDictionary<TestEnum, Int32> ITestDictStateClient.DictElement12 => LD_DictElement12.Interface;
        public IReadOnlyReactiveProperty<Int32?> GetDictElement12Property(TestEnum key)
        {
            return LD_DictElement12.GetProperty(key);
        }
        public IReadOnlyReactiveProperty<IReadOnlyReactiveCollection<Int32>> GetDictElement14Property(String key)
        {
            return LD_DictElement14.GetProperty(key);
        }
        public IReadOnlyReactiveProperty<IReadOnlyReactiveCollection<ITestSampleStateClient>> GetDictElement13Property(String key)
        {
            return LD_DictElement13.GetProperty(key);
        }
        ...
        private InternalLogicDictionary<String, Internal_ITestSampleState, ITestSampleState, ITestSampleStateClient> LD_DictElement8 = new InternalLogicDictionary<String, Internal_ITestSampleState, ITestSampleState, ITestSampleStateClient>();
        ...
        private InternalLogicDictionary<Int32, Internal_ITestSampleState, ITestSampleState, ITestSampleStateClient> LD_DictElement10 = new InternalLogicDictionary<Int32, Internal_ITestSampleState, ITestSampleState, ITestSampleStateClient>();
        ...
        private InternalInternalListDictionary<String, Internal_ITestSampleState,ITestSampleState, ITestSampleStateClient> LD_DictElement13 = new InternalInternalListDictionary<String, Internal_ITestSampleState,ITestSampleState, ITestSampleStateClient>();
