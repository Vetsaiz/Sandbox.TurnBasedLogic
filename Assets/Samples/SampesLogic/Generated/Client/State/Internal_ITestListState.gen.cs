...
{
    internal class Internal_ITestListState : ITestListStateClient, ITestListState 
    , IInitStateData 
    {
        ...
        IReadOnlyReactiveCollection<String> ITestListStateClient.ListElement => LL_ListElement.Interface;
        IReadOnlyReactiveCollection<Int32> ITestListStateClient.ListElement1 => LL_ListElement1.Interface;
        IReadOnlyReactiveCollection<Int64> ITestListStateClient.ListElement2 => LL_ListElement2.Interface;
        IReadOnlyReactiveCollection<Single> ITestListStateClient.ListElement3 => LL_ListElement3.Interface;
        IReadOnlyReactiveCollection<Double> ITestListStateClient.ListElement4 => LL_ListElement4.Interface;
        IReadOnlyReactiveCollection<Boolean> ITestListStateClient.ListElement5 => LL_ListElement5.Interface;
        IReadOnlyReactiveCollection<SimpleTestData> ITestListStateClient.ListElement6 => LL_ListElement6.Interface;
        IReadOnlyReactiveCollection<TestEnum> ITestListStateClient.ListElement7 => LL_ListElement7.Interface;
        IReadOnlyReactiveCollection<ITestSampleStateClient> ITestListStateClient.ListElement8 => LL_ListElement8.Interface;
        ...
        private InternalLogicList<Internal_ITestSampleState, ITestSampleState, ITestSampleStateClient> LL_ListElement8 = new InternalLogicList<Internal_ITestSampleState, ITestSampleState, ITestSampleStateClient>();
